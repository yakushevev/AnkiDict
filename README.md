...
## Обновление уже импортированных карточек- При повторном импорте готового `.apkg` файла Anki по умолчанию не перезаписывает существующие карточки, а игнорирует их.
